...
const cursors = [
  // PROFESSIONAL Category (5 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M8 2 L8 14 L6 14 L6 8 L4 8 L4 16 L6 16 L6 18 L4 18 L4 20 L18 20 L18 10 L16 10 L16 2 Z" fill="black" stroke="white" stroke-width="1"/><circle cx="12" cy="12" r="1.5" fill="white"/></svg>`),
    hotspotX: 2,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M10 10 L10 18 L8 18 L8 12 L6 12 L6 20 L8 20 L8 22 L6 22 L6 24 L18 24 L18 16 L16 16 L16 10 Z" fill="#1a1a1a" stroke="white" stroke-width="1"/><circle cx="12" cy="16" r="1.5" fill="white"/></svg>`),
    hotspotX: 10,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="6" fill="#1a1a1a"/><circle cx="16" cy="16" r="3" fill="#4b5563"/><path d="M16 2 L16 10 M16 22 L16 30 M2 16 L10 16 M22 16 L30 16" stroke="#1a1a1a" stroke-width="2.5"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 2 C10 2 6 6 6 12 C6 18 16 30 16 30 C16 30 26 18 26 12 C26 6 22 2 16 2 Z M16 16 C14 16 12 14 12 12 C12 10 14 8 16 8 C18 8 20 10 20 12 C20 14 18 16 16 16 Z" fill="#1e40af" stroke="white" stroke-width="1"/><circle cx="16" cy="12" r="3" fill="#60a5fa"/></svg>`),
    hotspotX: 16,
    hotspotY: 30,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M14 10 L14 16 L12 16 L12 12 L10 12 L10 18 L12 18 L12 20 L10 20 L10 22 L20 22 L20 16 L18 16 L18 10 Z" fill="#0f172a" stroke="white" stroke-width="1"/><circle cx="14" cy="16" r="1.5" fill="#60a5fa"/></svg>`),
    hotspotX: 16,
    hotspotY: 2,
    width: 32,
    height: 32,
  ...
  // FUN & PLAYFUL Category (8 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><defs><linearGradient id="rainbow2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#fbbf24"/><stop offset="50%" style="stop-color:#ff0080"/><stop offset="100%" style="stop-color:#7928ca"/></linearGradient></defs><path d="M16 2 L20 12 L30 14 L22 20 L24 30 L16 24 L8 30 L10 20 L2 14 L12 12 Z" fill="url(#rainbow2)" stroke="#fbbf24" stroke-width="2"/><circle cx="16" cy="16" r="3" fill="white" opacity="0.8"/></svg>`),
    hotspotX: 16,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="14" fill="#FFA500" stroke="#333" stroke-width="1"/><circle cx="11" cy="13" r="2" fill="#333"/><circle cx="21" cy="13" r="2" fill="#333"/><path d="M10 20 Q16 26 22 20" stroke="#333" stroke-width="2" fill="none"/><path d="M8 10 L14 8" stroke="#333" stroke-width="1.5"/><path d="M24 10 L18 8" stroke="#333" stroke-width="1.5"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M2 2 L2 28 L12 20 L17 30 L20 28 L15 18 L26 18 Z" fill="#7928ca" stroke="#00ff00" stroke-width="2"/><circle cx="10" cy="10" r="2" fill="#FFD700"/></svg>`),
    hotspotX: 2,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 2 L18 14 L30 16 L18 18 L16 30 L14 18 L2 16 L14 14 Z" fill="#c026d3" stroke="#fbbf24" stroke-width="2"/><circle cx="16" cy="16" r="4" fill="#fbbf24"/><circle cx="10" cy="10" r="2" fill="white" opacity="0.8"/><circle cx="22" cy="10" r="2" fill="white" opacity="0.8"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="24" cy="8" r="6" fill="#3b82f6" stroke="#1e40af" stroke-width="1" opacity="0.8"/><circle cx="22" cy="6" r="2" fill="white" opacity="0.9"/><circle cx="18" cy="12" r="4" fill="#60a5fa" opacity="0.6"/><circle cx="14" cy="8" r="3" fill="#93c5fd" opacity="0.5"/><line x1="18" y1="12" x2="4" y2="26" stroke="#64748b" stroke-width="3"/></svg>`),
    hotspotX: 4,
    hotspotY: 26,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="10" r="8" fill="#ec4899"/><circle cx="16" cy="10" r="6" fill="#f9a8d4"/><circle cx="16" cy="6" r="2" fill="#fbbf24"/><path d="M10 10 L16 28 L22 10 Z" fill="#d97706" stroke="#92400e" stroke-width="1"/></svg>`),
    hotspotX: 16,
    hotspotY: 28,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><ellipse cx="10" cy="24" rx="5" ry="4" fill="#a855f7"/><ellipse cx="20" cy="20" rx="5" ry="4" fill="#a855f7"/><path d="M15 24 L15 8 L25 6 L25 20" stroke="#a855f7" stroke-width="3" fill="none"/><circle cx="20" cy="10" r="2" fill="#fbbf24"/><circle cx="18" cy="6" r="1.5" fill="#fbbf24"/></svg>`),
    hotspotX: 10,
    hotspotY: 28,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="20" y="2" width="6" height="16" fill="#475569" stroke="#1e293b" stroke-width="1"/><path d="M20 18 L23 30 L26 18 Z" fill="#3b82f6"/><circle cx="23" cy="28" r="2" fill="#1e40af"/><path d="M10 8 Q15 10 18 12" stroke="#3b82f6" stroke-width="2" opacity="0.6"/></svg>`),
    hotspotX: 23,
    hotspotY: 30,
    width: 32,
    height: 32,
  ...
  // SEASONAL Category (5 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 2 L10 12 L12 12 L8 18 L10 18 L6 26 L26 26 L22 18 L24 18 L20 12 L22 12 Z" fill="#10b981" stroke="#047857" stroke-width="1"/><circle cx="16" cy="8" r="2" fill="#fbbf24"/><circle cx="13" cy="15" r="2" fill="#fbbf24"/><circle cx="19" cy="16" r="2" fill="#fbbf24"/><circle cx="16" cy="20" r="2" fill="#fbbf24"/><rect x="14" y="26" width="4" height="4" fill="#92400e"/><path d="M16 0 L17 4" stroke="#fbbf24" stroke-width="2"/></svg>`),
    hotspotX: 16,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 4 L16 28 M6 16 L26 16 M9 9 L23 23 M23 9 L9 23" stroke="#38bdf8" stroke-width="4" stroke-linecap="round"/><circle cx="16" cy="16" r="5" fill="#0ea5e9" stroke="#0284c7" stroke-width="1"/><circle cx="16" cy="6" r="1.5" fill="white"/><circle cx="16" cy="26" r="1.5" fill="white"/><circle cx="6" cy="16" r="1.5" fill="white"/><circle cx="26" cy="16" r="1.5" fill="white"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><ellipse cx="16" cy="18" rx="12" ry="10" fill="#ea580c" stroke="#c2410c" stroke-width="1"/><path d="M16 8 L14 12 L18 12 Z" fill="#15803d"/><path d="M10 15 L13 15 L12 18 Z" fill="#fbbf24"/><path d="M22 15 L19 15 L20 18 Z" fill="#fbbf24"/><path d="M11 22 Q16 26 21 22" stroke="#1f2937" stroke-width="2" fill="none"/><circle cx="16" cy="12" r="1" fill="#fbbf24" opacity="0.8"/></svg>`),
    hotspotX: 16,
    hotspotY: 8,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 28 C16 28 4 20 4 12 C4 8 6 6 9 6 C12 6 14 8 16 10 C18 8 20 6 23 6 C26 6 28 8 28 12 C28 20 16 28 16 28 Z" fill="#f43f5e" stroke="#991b1b" stroke-width="1"/><circle cx="12" cy="12" r="2" fill="white" opacity="0.6"/><path d="M16 14 L14 20 L16 18 L18 20 Z" fill="#fbbf24"/></svg>`),
    hotspotX: 16,
    hotspotY: 10,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><ellipse cx="16" cy="18" rx="10" ry="13" fill="#c084fc" stroke="#7c3aed" stroke-width="1"/><path d="M6 18 L26 18" stroke="#fbbf24" stroke-width="2"/><path d="M6 13 L26 13" stroke="#ec4899" stroke-width="2"/><path d="M6 23 L26 23" stroke="#10b981" stroke-width="2"/><circle cx="12" cy="15" r="2" fill="#fbbf24"/><circle cx="20" cy="21" r="2" fill="#ec4899"/><circle cx="16" cy="10" r="1.5" fill="white" opacity="0.8"/></svg>`),
    hotspotX: 16,
    hotspotY: 5,
    width: 32,
    height: 32,
  ...
  // GAMING Category (5 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M28 2 L18 12 L14 10 L10 14 L18 22 L22 18 L20 14 L30 4 Z" fill="#94a3b8" stroke="#1e293b" stroke-width="1"/><path d="M22 6 L26 10" stroke="#38bdf8" stroke-width="2"/><rect x="14" y="18" width="4" height="6" fill="#f59e0b" stroke="#78350f" stroke-width="1"/><rect x="12" y="24" width="8" height="3" fill="#fbbf24" stroke="#f59e0b" stroke-width="1"/></svg>`),
    hotspotX: 28,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="12" fill="none" stroke="#ef4444" stroke-width="2"/><circle cx="16" cy="16" r="6" fill="none" stroke="#ef4444" stroke-width="2"/><circle cx="16" cy="16" r="3" fill="#fbbf24"/><path d="M16 2 L16 10 M16 22 L16 30 M2 16 L10 16 M22 16 L30 16" stroke="#ef4444" stroke-width="2"/><circle cx="16" cy="16" r="14" fill="none" stroke="#fbbf24" stroke-width="1" opacity="0.5"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="4" y="10" width="24" height="12" rx="6" fill="#1f2937" stroke="#000" stroke-width="1"/><circle cx="11" cy="16" r="3" fill="#4b5563"/><circle cx="21" cy="16" r="2" fill="#f87171"/><circle cx="24" cy="13" r="2" fill="#60a5fa"/><circle cx="21" cy="16" r="1" fill="#fbbf24" opacity="0.8"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="8" y="4" width="4" height="12" fill="#f59e0b"/><rect x="12" y="4" width="4" height="16" fill="#f59e0b"/><rect x="16" y="4" width="4" height="16" fill="#f59e0b"/><rect x="20" y="8" width="4" height="12" fill="#f59e0b"/><rect x="4" y="16" width="20" height="8" fill="#f59e0b"/><rect x="10" y="6" width="2" height="2" fill="#fbbf24"/><rect x="14" y="6" width="2" height="2" fill="#fbbf24"/><rect x="18" y="10" width="2" height="2" fill="#fbbf24"/></svg>`),
    hotspotX: 12,
    hotspotY: 4,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><line x1="4" y1="28" x2="22" y2="10" stroke="#818cf8" stroke-width="3"/><path d="M24 8 L26 2 L28 8 L34 10 L28 12 L26 18 L24 12 L18 10 Z" fill="#fbbf24" stroke="#f59e0b" stroke-width="1" transform="translate(-6,-4) scale(0.8)"/><circle cx="14" cy="18" r="2" fill="#fbbf24" opacity="0.6"/><circle cx="18" cy="14" r="1.5" fill="#fbbf24" opacity="0.6"/></svg>`),
    hotspotX: 4,
    hotspotY: 28,
    width: 32,
    height: 32,
  ...
  // FASHION & BEAUTY Category (4 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M8 8 L12 16 L4 18 L2 28 L6 28 L10 20 L26 20 L24 16 L14 14 Z" fill="#f472b6" stroke="#be185d" stroke-width="1"/><circle cx="18" cy="18" r="2" fill="#fbbf24"/><circle cx="22" cy="18" r="1.5" fill="#fbbf24"/></svg>`),
    hotspotX: 8,
    hotspotY: 8,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="12" y="18" width="8" height="10" rx="1" fill="#fbbf24" stroke="#f59e0b" stroke-width="1"/><rect x="13" y="8" width="6" height="10" fill="#f43f5e" stroke="#991b1b" stroke-width="1"/><path d="M13 8 L16 2 L19 8 Z" fill="#f43f5e" stroke="#991b1b" stroke-width="1"/><circle cx="16" cy="12" r="1.5" fill="white" opacity="0.6"/></svg>`),
    hotspotX: 16,
    hotspotY: 2,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="6" y="10" width="20" height="18" rx="1" fill="#c084fc" stroke="#7e22ce" stroke-width="1"/><path d="M11 10 C11 6 13 4 16 4 C19 4 21 6 21 10" stroke="#7e22ce" stroke-width="2" fill="none"/><circle cx="16" cy="18" r="3" fill="#fbbf24"/><path d="M14 18 L15 20 L18 16" stroke="white" stroke-width="1.5" fill="none"/></svg>`),
    hotspotX: 16,
    hotspotY: 4,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><ellipse cx="16" cy="22" rx="8" ry="3" fill="#fbbf24" stroke="#f59e0b" stroke-width="1"/><path d="M13 8 L16 2 L19 8 L22 14 L10 14 Z" fill="#38bdf8" stroke="#0284c7" stroke-width="1"/><path d="M13 14 L16 8 L19 14" stroke="#0284c7" stroke-width="0.5"/><circle cx="14" cy="10" r="1.5" fill="white" opacity="0.8"/><circle cx="18" cy="11" r="1" fill="white" opacity="0.8"/><path d="M16 4 L17 6" stroke="#fbbf24" stroke-width="1.5"/></svg>`),
    hotspotX: 16,
    hotspotY: 2,
    width: 32,
    height: 32,
  ...
  // MINIMAL Category (3 cursors)
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16" r="10" fill="none" stroke="#000" stroke-width="2"/><circle cx="16" cy="16" r="3" fill="#000"/><circle cx="16" cy="16" r="6" fill="none" stroke="#000" stroke-width="1"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M16 6 L16 26 M6 16 L26 16" stroke="#000" stroke-width="3" stroke-linecap="round"/><circle cx="16" cy="16" r="4" fill="none" stroke="#000" stroke-width="1.5"/></svg>`),
    hotspotX: 16,
    hotspotY: 16,
    width: 32,
    height: 32,
  },
  {
    ...
    hoverImageUrl: createSVGCursor(`<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M4 4 L4 24 L12 18 L16 28 L18 27 L14 17 L24 17 Z" fill="none" stroke="#000" stroke-width="2"/><circle cx="10" cy="10" r="2" fill="#000"/></svg>`),
    hotspotX: 4,
    hotspotY: 4,
    width: 32,
    height: 32,
